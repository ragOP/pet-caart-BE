...
app.use('/api/send-notification', require('./routes/send_notification/index'));
app.use('/api/page-config', require('./routes/page_config/index'));
app.use('/api/campaign', require('./routes/campaign/index'));
